...
import { createTest, finalizeTest, getTestResults, getTestSessionById, updateAnswer } from "../controller/test.controller.js";
const route = Router();
...
route.get("/test-session/:id", verifyJWT, getTestSessionById);
