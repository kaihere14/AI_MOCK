...
const InterviewCard = (props) => {
  return (
    <div
      className="bg-[#18252C] rounded-xl sm:rounded-2xl min-h-50 w-full py-4 sm:py-6 px-3 sm:px-4 overflow-hidden shadow-lg gap-2 flex flex-col cursor-pointer hover:bg-[#1f2f38] transition-all duration-300 hover:shadow-xl hover:scale-[1.02] sm:hover:scale-105"
