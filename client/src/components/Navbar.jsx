    ...
    <div className="w-full bg-black">
      <nav className="bg-black border-b border-gray-900 px-4 md:px-6 lg:px-10 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={() => {
              updateActiveItem("Reports");
              navigate("/allreports");
            }}
            className="hidden sm:flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-pink-400 to-blue-400 hover:from-pink-500 hover:to-blue-500 text-white rounded-lg font-semibold transition-all duration-300 text-xs"
          >
            <svg
              className="w-4 h-4"
              fill="none"
